...
- (id)init
{
    ...
    if (self) {
        ...
        NSString *moviePath = [[NSBundle mainBundle] pathForResource:@"killer" ofType:@"mp4"];
//        if(moviePath){
//            _localMovies = @[
//                             @"moviePath",
//                             @"aaaaaaa"
...
//        }
        ...
        _remoteMovies = @[
            ...
            @"http://183.251.61.207/PLTV/88888888/224/3221225922/index.m3u8",
...
- (void) reloadMovies
{
    ...
    [ma addObjectsFromArray:[bundle pathsForResourcesOfType:@"mp4" inDirectory:@""]];
